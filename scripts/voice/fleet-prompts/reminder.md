...
> "No problem at all - let's move it rather than lose it. I have tomorrow at ten or Thursday at one, Sydney time... Done, it's moved to tomorrow at ten, and the updated invitation is on its way."
...
> "Worth checking spam - it comes from our calendar, with the video link in it. If it's still missing, the team can resend it; I'll flag it for them either way. The session details stand: it's at the booked time, online."
