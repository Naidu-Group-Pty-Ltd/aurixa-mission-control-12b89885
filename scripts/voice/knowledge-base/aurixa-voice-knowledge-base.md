...
### What problem does Aurixa solve?
...
### Who built Aurixa, and does it understand how a firm like ours works?
...
### Why are firms looking at this now?
...
### What actually changes for a firm day to day?
...
### Is Aurixa Systems the same as the platform my firm uses?
...
## 2. What Aurixa does for your kind of firm
...
### What would Aurixa do for a buyer's agency?
...
### What would Aurixa do for a property advisory or investment firm?
...
### What would Aurixa do for a wealth or financial adviser?
...
### What would Aurixa do for a mortgage or finance broker?
...
### What would Aurixa do for a real estate agency?
...
### What would Aurixa do for a conveyancer or solicitor?
...
### What would Aurixa do for an accountant or SMSF adviser?
...
### What would Aurixa do for a developer or builder?
...
### What would Aurixa do for a multi-office group, network or franchise?
...
### What if my kind of business isn't listed?
...
### How is Aurixa different from what we use now?
...
### We already have a CRM. How is this different?
...
### Why not build something like this ourselves?
...
### What does white-labelled mean for us?
...
### How is the AML/CTF side different from doing it by hand?
...
Ask back: "Roughly how many hours a week would you say go on admin and pulling reports together?"
...
Ask back: "If you could take a few hours of admin off your week, where would you put that time?"
...
Ask back: "Where do things tend to slow down between your systems?"
...
Ask back: "Is there a point later in the year when this would make more sense to look at?"
...
### "Why do I have to apply? Can't I just buy it?"
...
### "We already handle AML another way."

That's fine - the AML/CTF module is optional. Every plan can be taken without it, at A$150 a month less, and everything else in the platform works the same. Having customer due diligence in the same place as the client record can still be useful, but that is the firm's call.

### "I'm not comfortable putting client data into an AI system."
...
### "Switching sounds like a lot of work."
...
Ask back: "What would you most want to bring across from your current setup?"
...
Ask back: "Would it be easier to book a time when you can both be there?"
...
### "What if it doesn't suit how we work?"
...
### "I'm just looking - I'm not sure what I need yet."
...
Ask back: "What made you look into this in the first place?"

## 5. Understanding a firm - discovery

### What questions help me understand what a firm needs?
...
### What should I listen for, and what does it point to?
...
### How do I move from a conversation to a next step?
...
### What does it look like when a new client comes in?
...
### What does a handover to a broker look like?
...
### What does it look like for a builder's stock?
...
### Client records and day-to-day workflow
...
### Portals - what clients and partners see
...
- Launch, for 1 to 4 seats - For a solo adviser or a small team getting started.
- Growth, for 5 to 15 seats - For a growing practice running comparisons and a deal pipeline.
- Scale, for 16 to 30 seats - The full platform, with finance, marketing and agreements.
...
- Launch includes Overview, Calendar, Reports, Generated Reports (Investment), Cash Flow Analysis (10 Year Cash Flow), Report Requests, Clients, Client Tracker, Reminders, Checklist, Game Plan, User Guide, Billing & Usage, Settings, User Management, Branding, Error Logs, Activity Logs, Client Portal and AML/CTF Compliance.
- Growth includes everything in Launch, plus Generated Reports (Comparisons), Cash Flow Analysis (Comparisons), Clients (Deals) and Deal Pipeline.
- Scale includes everything in Growth, plus Market Updates, Commercial / Industrial, Opportunity Marketplace, Clients (Send To Finance, Portfolio Analysis, Send Portfolio To Client, Send Agreement, Conversations, Appointments, Finance Messages, Borrowing Capacity and AI), Agreements, Marketing, Model Hub, Finance Portal and API Usage.
...
### Can we add just one module without changing plan?
...
## 10. Credits - what they are and how they are spent
...
## 11. How access works - the priority access pathway
...
### Why is the strategic review worth the time?
...
## 12. Onboarding - what happens after signing
...
### What do the onboarding packages cost?
...
### Can you meet our security review requirements?
...
### Should I send documents or client details on this call?
...
## 14. Support for existing customers
...
### I am not a customer yet but I have a technical question.
...
## 15. Billing and account questions
...
## 16. What a caller can do on this call
...
### Can you look at my account or fix something for me?
...
### Can you tell me if my application was approved?
...
## 18. What an agent must never say
